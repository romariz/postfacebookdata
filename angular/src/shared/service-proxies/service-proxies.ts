...
export class ServiceServiceProxy {
     ...
     * @return Success
     */
    create(input: CreateServiceDto | null | undefined): Observable<ServiceDto> {
    ...
    protected processCreate(response: HttpResponseBase): Observable<ServiceDto> {
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
                let result200: any = null;
                let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
                result200 = resultData200 ? ServiceDto.fromJS(resultData200) : new ServiceDto();
                return _observableOf(result200);
            }));
        } else if (status === 401) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
     ...
     * @return Success
     */
    get(id: number | null | undefined): Observable<ServiceDto> {
     ...
     * @return Success
     */
    getAll(skipCount: number | null | undefined, maxResultCount: number | null | undefined): Observable<PagedResultDtoOfServiceDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_: any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PagedResultDtoOfServiceDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfServiceDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<PagedResultDtoOfServiceDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
                let result200: any = null;
                let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
                result200 = resultData200 ? PagedResultDtoOfServiceDto.fromJS(resultData200) : new PagedResultDtoOfServiceDto();
                return _observableOf(result200);
            }));
        } else if (status === 401) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PagedResultDtoOfServiceDto>(<any>null);
    }
     ...
     * @return Success
     */
    update(input: ServiceDto | null | undefined): Observable<ServiceDto> {
...
export class PagedResultDtoOfServiceDto implements IPagedResultDtoOfServiceDto {
    totalCount: number | undefined;
    items: ServiceDto[] | undefined;

    constructor(data?: IPagedResultDtoOfServiceDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): PagedResultDtoOfServiceDto {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultDtoOfServiceDto();
        result.init(data);
        return result;
    }
    ...
    clone(): PagedResultDtoOfServiceDto {
        const json = this.toJSON();
        let result = new PagedResultDtoOfServiceDto();
        result.init(json);
        return result;
...
export interface IPagedResultDtoOfServiceDto {
    totalCount: number | undefined;
    items: ServiceDto[] | undefined;
}
